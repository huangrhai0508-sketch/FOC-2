...
clear text;
clear alldata;
[ndata, text, alldata] = xlsread('ParameterGenerator.xlsx','ParameterDefinition2');
[n,m] = size(alldata);
...
for i = 2:1:n
    ...
    eval([ParameterName, '.CoderInfo.CustomAttributes.HeaderFile=''parameter0.h'';']);
    eval([ParameterName, '.CoderInfo.CustomAttributes.DefinitionFile=''parameter0.c'';']);
