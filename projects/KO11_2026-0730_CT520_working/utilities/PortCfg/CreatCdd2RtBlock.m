...
% Creat cddRt block in pmsmfoc.slx model
% name the signal
%     name = CDDIN2ST.Elements(i).Name;
...
%%
% creat a slx file
modelName = [mdlNameCore2 '/SAQ/cddRt'];
if(~bdIsLoaded(mdlNameCore2))
     open_system(mdlNameCore2);
 end
...
outputSignalNumber = length(CDDIN2ST.Elements);
