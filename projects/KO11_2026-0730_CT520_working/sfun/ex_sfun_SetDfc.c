 ...
 *
 *         void SetDfcShell(boolean u1,boolean u2, uint16 u3, uint32 u4)
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 24-Sep-2018 01:06:24
 *
...
/**
     ...
     def.HeaderFiles = {'C2SfunShell.h', 'Platform_Types.h', 'LIB_Atan2.h', 'LIB_SinCosCalc.h', 'LIB_SqrtCalc.h'};
     def.SourceFiles = {'C2SfunShell.c', 'LIB_Atan2.c', 'LIB_SinCosCalc.c', 'LIB_SqrtCalc.c'};
     def.IncPaths = {'C:\MatlabWS\motorcontrol\sfun', 'C:\MatlabWS\motorcontrol\sfun\MathLib'};
...
#define S_FUNCTION_NAME  ex_sfun_SetDfc
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "SetDfcShell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    boolean_T* u1 = (boolean_T*) ssGetInputPortSignal(S, 0);
    boolean_T* u2 = (boolean_T*) ssGetInputPortSignal(S, 1);
    uint16_T* u3 = (uint16_T*) ssGetInputPortSignal(S, 2);
    uint32_T* u4 = (uint32_T*) ssGetInputPortSignal(S, 3);


    /* Call the legacy code function */
    SetDfcShell(*u1, *u2, *u3, *u4);
}
