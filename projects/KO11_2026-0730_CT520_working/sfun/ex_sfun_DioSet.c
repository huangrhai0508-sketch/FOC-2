 ...
 *
 *         void DioSetShell(boolean u1, uint16 u2, boolean y1[1])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 24-Sep-2018 01:06:34
 *
...
#define S_FUNCTION_NAME  ex_sfun_DioSet
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "DioSetShell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
