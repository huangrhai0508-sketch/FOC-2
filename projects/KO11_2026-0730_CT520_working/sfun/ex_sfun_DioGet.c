 ...
 *
 *         void DioGetShell(boolean u1, uint16 u2, boolean y1[1])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 28-Sep-2018 17:15:11
 *
...
#define S_FUNCTION_NAME  ex_sfun_DioGet
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "DioGetShell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
