 ...
 *
 *         void Atan2Shell(single u1,single u2,uint16 y1[1])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 24-Sep-2018 01:06:14
 *
...
#define S_FUNCTION_NAME  ex_sfun_Atan2
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "Atan2Shell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
