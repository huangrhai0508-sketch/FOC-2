/**
 * ex_sfun_LIB_SqrtCalc.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void SqrtShell(single u1,single y1[1],single y2[1])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 24-Sep-2018 01:06:10
 *
...
#define S_FUNCTION_NAME  ex_sfun_LIB_SqrtCalc
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "SqrtShell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
