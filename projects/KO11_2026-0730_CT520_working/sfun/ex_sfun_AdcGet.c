 ...
 *
 *         void AdcGetShell(uint16 u1, uint16 u2, uint16 y1[1])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 28-Sep-2018 17:15:27
 *
...
#define S_FUNCTION_NAME  ex_sfun_AdcGet
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AdcGetShell", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
