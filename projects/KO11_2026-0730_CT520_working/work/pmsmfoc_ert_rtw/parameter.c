...
const volatile real32_T IdROL_C = 15.0F;
const volatile boolean_T PWMFrqSwitch_C = true;
const volatile real32_T SC_Ld_P = 0.0019947F;
const volatile real32_T SC_Lq_P = 0.004955F;
const volatile real32_T SC_Psi_P = 0.038641F;
...
const volatile real32_T g_msgCore0to2_AcrKp = 2.0F;
const volatile real32_T g_msgCore0to2_AcrKpStb = 4.0F;
const volatile real32_T g_msgCore0to2_AcrSwtHiRpm = 200.0F;
const volatile real32_T g_msgCore0to2_AcrSwtLoRpm = 100.0F;
...
const volatile real32_T g_msgCore0to2_FFW_Gain = 1.0F;
const volatile real32_T g_msgCore0to2_L1 = 50.0F;
const volatile real32_T g_msgCore0to2_L2 = 260.0F;
const volatile real32_T g_msgCore0to2_MTPA_Gain = 1.0F;
const volatile real32_T g_msgCore0to2_N111 = 2.0F;
const volatile real32_T g_msgCore0to2_N222 = 6.0F;
const volatile real32_T g_msgCore0to2_arc_dd_fi = 1.0F;
const volatile boolean_T g_msgCore0to2_clpwitch = false;
const volatile real32_T g_msgCore0to2_depth = 0.01F;
const volatile real32_T g_msgCore0to2_detlaAngle_single = 0.5F;
const volatile real32_T g_msgCore0to2_dqLpf = 0.5F;
const volatile real32_T g_msgCore0to2_dqLpfSpdCoef = 0.01F;
const volatile real32_T g_msgCore0to2_fbw = 20.0F;
...
const volatile real32_T g_msgCore0to2_spdswitch = 500.0F;
const volatile real32_T g_msgCore0to2_wb = 0.1F;
