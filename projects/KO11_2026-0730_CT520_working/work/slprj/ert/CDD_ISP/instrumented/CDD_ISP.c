                 ...
                 *y_ISP_nNotch2)
{
  ...
  *y_Iddes = CDD_ISPpmsmfoc_rtDWork.Iddes;
  ...
  if (rtb_Equal) {
    ...
    profileStart_CDD_ISP(1U); /* original_line:1150 */rtb_agNegTrans = (int16_T)((int32_T)floorf(182.041672F *
      CDD_ISPpmsmfoc_rtDWork.Angle));profileEnd_CDD_ISP(1U); /* original_line:1151 */
  }
  ...
  profileStart_CDD_ISP(2U); /* original_line:1275 */y_ISP_Out->Core2_ISP_nx.Core2_ISP_agOffsCal = (int16_T)((int32_T)floorf
    (((CDD_ISPpmsmfoc_rtDWork.agOffs_Caltemp_pos +
       CDD_ISPpmsmfoc_rtDWork.agOffs_Caltemp_neg) / 2.0F) * 182.041672F));profileEnd_CDD_ISP(2U); /* original_line:1277 */
  ...
  profileStart_CDD_ISP(3U); /* original_line:1282 */y_ISP_Out->Core2_ISP_nx.Core2_ISP_nAbs = fabsf(rtb_Abs1);profileEnd_CDD_ISP(3U); /* original_line:1282 */
  ...
  /* Abs: '<S3>/Abs1' */
  profileStart_CDD_ISP(4U); /* original_line:1349 */rtb_Abs1 = fabsf(ISP_speedref_final_wn);profileEnd_CDD_ISP(4U); /* original_line:1349 */
  ...
  profileStart_CDD_ISP(5U); /* original_line:1401 */rtb_UnitDelay14 = 1.0F - sqrtf(((rtb_UnitDelay12 * rtb_UnitDelay12) /
    rtb_UnitDelay14_tmp) + 1.0F);profileEnd_CDD_ISP(5U); /* original_line:1402 */
  ...
  profileStart_CDD_ISP(6U); /* original_line:1408 */k1_0 = sqrtf(rtb_UnitDelay14 / temp2_tmp_tmp);profileEnd_CDD_ISP(6U); /* original_line:1408 */
  ...
  *y_ISP_nNotch = (((((b1_0 * ISP_n) + (b2_0 * X111)) + (b1_tmp * X222)) -
  ...
  rtb_UnitDelay14_tmp = rtb_Gain1 * rtb_Gain1;
  profileStart_CDD_ISP(7U); /* original_line:1537 */k1_0 = sqrtf((1.0F - sqrtf(((rtb_Abs1 * rtb_Abs1) / rtb_UnitDelay14_tmp) +
    1.0F)) / (((g_msgCore0to2_depth * g_msgCore0to2_depth) * 4.0F) - 2.0F));profileEnd_CDD_ISP(7U); /* original_line:1538 */
...
void CDD_ISPTID1(void)
{
  ...
  profileStart_CDD_ISP(8U); /* original_line:1746 */tmp = floorf(rtb_Divide);profileEnd_CDD_ISP(8U); /* original_line:1746 */
  if (tmp < 32768.0F) {
    if (tmp >= -32768.0F) {
