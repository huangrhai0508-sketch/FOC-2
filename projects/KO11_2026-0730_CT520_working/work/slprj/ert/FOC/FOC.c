                 ...
                 *y_f32_Duty_f32_DutyVon, real32_T *y_f32_Duty_f32_DutyWon)
{
  ...
  hfht11bpny_prot(&PMC_UsdScal, &PMC_UsqScal, &FOCpmsmfoc_rtDWork.Model1_o3,
             ...
             *y_isdSet_last, real32_T *y_Ts, real32_T *y_Id, real32_T *y_Iq)
{
  ...
  *y_Iq = (rtb_Gain3_f * rtb_Subtract) - (rtb_Gain2_h * rtb_Sin);
   ...
   */
  rtb_Subtract = look2_iflf_pbinlca(ISP_iQaFild, rtb_Sin, (const real32_T *)
  ...
  rtb_Sin = look1_iflf_pbinlca(ISP_iQaFild, (const real32_T *)
    ...
    &FOCpmsmfoc_rtDWork.m_bpIndex_c, 120U);
   ...
   */
  rtb_Gain3_f = fminf(f32_P_Modulation, *u_f32_ModulationReq);
  ...
  *y_Ts = 1.0F / PMC_pwmfrq;
   ...
   */
  usage = (sqrtf((FOCpmsmfoc_rtDWork.UnitDelay2_DSTATE *
    ...
    ((1.0F - rtb_Subtract) * FOCpmsmfoc_rtDWork.UnitDelay1_DSTATE_j);
  ...
  switch (rtAction) {
   case 0:
     ...
     *  Product: '<S26>/Divide'
     */
    rtb_Gain2_h = ((0.408248305F * rtb_Product1) * f32_P_Modulation) * (1.0F /
      fmaxf(62.831852F, fabsf(6.28318548F * rtb_Sin)));
     ...
     *  Saturate: '<S33>/Saturation'
     */
    rtb_Gain2_h = look2_iflf_pbinlca(rtb_Subtract, PMC_PsiMax, (const real32_T *)
     ...
     *  Product: '<S33>/Divide'
     */
    rtb_Gain2_h = -fabsf(g_msgCore0to2_maxCur * fminf
    ...
    if (g_msgCore0to2_CalibEn) {
       ...
       *  Abs: '<S33>/Abs'
       */
      rtb_Switch2_c = look2_iflf_pbinlca(rtb_Subtract, 0.0F, (const real32_T *)
     ...
     *  MinMax: '<S33>/MinMax1'
     */
    rtb_Subtract = fmaxf(rtb_Gain2_h, fminf(PMC_FFW_opt, PMC_MTPA_opt));
     ...
     *  MinMax: '<S24>/Min2'
     */
    rtb_Sin = fmaxf(PMC_MTPA_opt, rtb_Gain2_h) - rtb_Subtract;
    ...
    if ((rtb_Gain2_h - (rtb_Sin * rtb_Sin)) <= 0.0F) {
       ...
       *  Abs: '<S36>/Abs'
       */
      FOCpmsmfoc_rtDWork.Sqrt = sqrtf(fabsf(rtb_Gain2_h));
   ...
   */
  rtb_Sin = (sqrtf(fmaxf(((*y_Iq) * (*y_Iq)) + ((*y_Id) * (*y_Id)), 0.0F)) *
             0.05F) + (FOCpmsmfoc_rtDWork.UnitDelay1_DSTATE_eu * 0.95F);
  ...
  if (*u_Drive) {
    ...
    temp2 = (sqrtf(1.17722499F - (pi_d_AxleOutput * pi_d_AxleOutput)) * 0.1F) +
      (0.9F * FOCpmsmfoc_rtDWork.UnitDelay5_DSTATE);
   ...
   */
  currentloop(u_Drive, &PMC_IsdDes, &PMC_isdFlt, &PMC_IsqDes, &PMC_isqFlt, y_Ts,
  ...
  SVPWM(u_Drive, &rtb_Gain3_f, &rtb_Gain2_h, &rtb_angleElec, &rtb_Add3,
