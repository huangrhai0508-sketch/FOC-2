...
/* Code instrumentation offset(s) for model FOCSpdTrq */
#define profileStart_FOCSpdTrq_offset  0
#define profileEnd_FOCSpdTrq_offset    0
...
/* Code instrumentation method(s) for model FOCSpdTrq */
void profileStart_FOCSpdTrq(uint32_T sectionId)
{
  profileStart(profileStart_FOCSpdTrq_offset + sectionId);
}

void profileEnd_FOCSpdTrq(uint32_T sectionId)
{
  profileEnd(profileEnd_FOCSpdTrq_offset + sectionId);
}
