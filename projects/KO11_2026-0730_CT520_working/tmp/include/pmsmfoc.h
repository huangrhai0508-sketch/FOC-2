...
typedef struct {
  ...
  volatile boolean_T RateTransition5_Buffer0_d;/* '<S4>/Rate Transition5' */
} pmsmfoc_D_Work;
...
extern real32_T PMC_UsqScal;           /* '<S4>/Constant2' */
