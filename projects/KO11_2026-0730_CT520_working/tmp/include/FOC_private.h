...
extern const uint32_T rtCP_pooled_Nb5SlSGKFzjB[2];
extern const uint32_T rtCP_pooled_5V6edGmokdkO[2];
extern const uint32_T rtCP_pooled_G77zBOsJooPp[2];
extern const uint16_T rtCP_pooled_x7BvxfwTjxoN;

#define rtCP_cLdAdpt_maxIndex          rtCP_pooled_Nb5SlSGKFzjB  /* Computed Parameter: rtCP_cLdAdpt_maxIndex
                                                                  * Referenced by: '<S35>/cLdAdpt'
                                                                  */
#define rtCP_cLqAdpt_maxIndex          rtCP_pooled_Nb5SlSGKFzjB  /* Computed Parameter: rtCP_cLqAdpt_maxIndex
                                                                  * Referenced by: '<S35>/cLqAdpt'
                                                                  */
#define rtCP_MTPA_T_maxIndex           rtCP_pooled_5V6edGmokdkO  /* Computed Parameter: rtCP_MTPA_T_maxIndex
                                                                  * Referenced by: '<S27>/MTPA_T'
                                                                  */
#define rtCP_ExFeedBack_maxIndex       rtCP_pooled_G77zBOsJooPp  /* Computed Parameter: rtCP_ExFeedBack_maxIndex
                                                                  * Referenced by: '<S27>/ExFeedBack'
                                                                  */
#define rtCP_Constant3_Value_i         rtCP_pooled_x7BvxfwTjxoN  /* Computed Parameter: rtCP_Constant3_Value_i
